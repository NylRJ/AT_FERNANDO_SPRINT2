package com.i9developement.school.avaliacao.entity;
...
import com.i9developement.school.avaliacao.valueobject.Staus;
import com.i9developement.school.avaliacao.valueobject.StausCorrecao;
...
public class Disciplina extends RepresentationModel<Disciplina>  implements Serializable {
	...
	private Integer statusCorrecao;
	...
	public Disciplina(Long id, String disciplinaCodigo, String disciplinaName, String matricula,String nomeAluno, Staus status) {
		super();
		this.id = id;
	...
	public Disciplina(Long id, String disciplinaName, String disciplinaCodigo, Staus status, StausCorrecao statusCorrecao) {
		super();
		this.id = id;
		this.disciplinaName = disciplinaName;
		this.disciplinaCodigo = disciplinaCodigo;
		this.status = (status == null) ? null : status.getCodigo();
		this.setStatusCorrecao((statusCorrecao == null) ? null : statusCorrecao.getCodigo());
	}
	...
	public Integer getStatusCorrecao() {
		return statusCorrecao;
	}

	public void setStatusCorrecao(Integer statusCorrecao) {
